...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, Lets start with Knowing about COVID. You can ask for national or state covid 19 data. May I know Your Name, Location and Temperature Before Starting.."
...
class addDetails(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        url = "https://3qi99ji96j.execute-api.us-east-2.amazonaws.com/personDetails?personName="+str(person_name_value)+"&personLocation="+str(person_location_value)+"&temperature="+str(temparature_value)
        response = requests.get(url)
        speak_output=" Your Details are Registered {}, I hope It's wounderfull Growing up at {}, Must be very fascinating to you. Okay, you are having {} Temperature and You dont need to worry! I Wish I could help you more, Please check @https://covidindia.org/ For more information and guidelines about COVID-19".format(person_name_value, person_location_value, temparature_value)
...
class MildConditionHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output="Hey! I guess you have nothing to worry much, anyways, Please maintain social distance and stick to precautions. There are mild chances that you can get infected by Carona Virus "
